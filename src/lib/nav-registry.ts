...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  },
  {
    ...
    description: "Tutor that uses your notes, decks, and mocks in this chat.",
    featureKey: "tutor",
    surfaces: surf({ sidebar: true, mobile: true, palette: true, landing: true, matrix: true }),
  ...
  },
  {
    ...
    icon: Target,
    section: "study",
    keywords: ["focus", "mode", "session", "score", "distractions"],
    description: "Timed deep-work sessions with distraction tracking.",
    featureKey: "focus",
    surfaces: surf({ sidebar: true, mobile: true, palette: true, landing: true, matrix: true }),
  },
  {
    ...
    icon: Brain,
    section: "study",
    keywords: ["learning", "style", "quiz", "preference"],
    description: "Preference quiz — not a measured ability score.",
  ...
  },
  {
    ...
    icon: CalendarDays,
    section: "track",
    keywords: ["planner", "weekly", "schedule", "plan", "mock"],
    description: "Time-block today with exams and mocks in view.",
    featureKey: "planner",
    surfaces: surf({ sidebar: true, mobile: true, palette: true, landing: true, matrix: true }),
  },
  {
  ...
  },
  {
    ...
    icon: Handshake,
    section: "social",
    keywords: ["ai", "feedback", "essay", "notes", "review"],
    description: "Instant AI critique — not a human peer queue.",
