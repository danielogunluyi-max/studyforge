...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Success banners */}
      {resetSuccess && !error && (
        <div className="mb-5 flex items-center gap-2.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-400 shadow-[0_0_20px_-4px_rgba(16,185,129,0.2)]">
