...
export function Sidebar({ mobileOpen, onCloseMobile }: SidebarProps) {
  ...
  const mainItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: <NavIcon><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg></NavIcon>,
    },
    {
      href: "/feynman",
  ...
  const featureItems: NavItem[] = [
    {
      href: "/presentation",
      label: "Presentations",
      icon: <NavIcon><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></NavIcon>,
    },
    {
      href: "/focus",
      label: "Focus Mode",
